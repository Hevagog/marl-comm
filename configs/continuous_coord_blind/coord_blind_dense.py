# fmt: off
"""CC Blind — MAGIC Dense.

GAT scheduler routes "I see target X at p" through msg layer — agents fill
zeroed peer slots via comm graph. Baseline for recurrent encoders.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_cc_blind_dense_857", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "cc_blind", "magic_dense"]},
        "write_interval": 25_000, "checkpoint_interval": 2_000_000, "store_separately": False,
    },
    "env": _ENV,
    "training": {"timesteps": 4_000_000, "seed": 857},
