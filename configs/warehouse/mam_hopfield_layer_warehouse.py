# fmt: off
# §6.3: MAM Encoder-Only + HopfieldLayer (Prototype-Based Agent Reasoning)
...
CONFIG = {
    "experiment": {
        "name":             "mam_hopfield_layer_4ag",
        "agent_type":       "mam_hopfield_layer",
        "directory":        "runs",
        "wandb":            True,
        "wandb_kwargs": {
            "project": "marl-comm",
            "tags":    ["mam_hopfield_layer", "warehouse", "4agents", "sec6.3"],
        },
    ...
    "mam": {
        ...
        # ---- §6.3 HopfieldLayer hyperparameters ----
        "num_prototypes": 8,    # P learned coordination prototypes
        "proto_beta":     1.5,  # inverse temperature (softer retrieval)
    },
