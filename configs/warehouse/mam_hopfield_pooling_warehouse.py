# fmt: off
# §6.1: MAM Encoder-Only + HopfieldPooling (Coordination Bottleneck)
...
CONFIG = {
    "experiment": {
        "name":             "mam_hopfield_pooling_4ag",
        "agent_type":       "mam_hopfield_pooling",
        "directory":        "runs",
        "wandb":            True,
        "wandb_kwargs": {
            "project": "marl-comm",
            "tags":    ["mam_hopfield_pooling", "warehouse", "4agents", "sec6.1"],
        },
    ...
    "mam": {
        ...
        # ---- BiMamba architecture (same as ablation 1) ----
        "n_embd":      128,
        "n_block":     1,
        "d_state":     32,
        "d_conv":      4,
        ...
        # ---- §6.1 HopfieldPooling hyperparameters ----
        "num_pool_queries": 4,    # K learned queries (Ramsauer et al. 2021)
        "pool_beta":        1.0,  # inverse temperature for softmax retrieval
    },
