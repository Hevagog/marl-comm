...
CONFIG = {
    "experiment": {
        "name":             "mam_et_encoder_warehouse_24_32_16_randomize_layout",
        "agent_type":       "mam_et_encoder",
        "directory":        "runs",
        "wandb":            True,
        "wandb_kwargs": {
            "project": "marl-comm",
            "tags":    ["mam_et_encoder", "warehouse"],
        },
