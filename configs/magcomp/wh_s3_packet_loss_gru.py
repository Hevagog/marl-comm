# fmt: off
"""S3 Packet Loss — MAGIC GRU.

Same temporal-noise filtering role as LSTM, lighter cell. Often matches
LSTM on RL horizons under PPO; preferred when TBPTT(1) is the only depth.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s3_gru", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s3", "magic_gru"]},
