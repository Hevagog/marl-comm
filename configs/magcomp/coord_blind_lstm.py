...
Cell holds last-known target/peer position across the steps the slot is
zeroed. Combined with GAT comm, complementary memory axis.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_cc_blind_lstm", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "cc_blind", "magic_lstm"]},
