# fmt: off
"""Coin Game — MAGIC Episodic Hopfield.

Buffer T=8 (max_cycles=50, smaller chain than warehouse). Pattern completion
of "opponent stole" event recurrence may stabilise reciprocity. Carry 8×32=256.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_coingame_eh", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "coingame", "magic_eh"]},
