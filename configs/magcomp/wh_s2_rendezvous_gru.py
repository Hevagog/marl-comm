# fmt: off
"""S2 Rendezvous — MAGIC GRU (TBPTT(1)).

GRU keeps last-seen peer offset in h_t between out-of-vision steps; lighter
than LSTM and better suited to single-step gradient depth. Same
peer-tracking role as LSTM variant for vision_range=1.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s2_gru", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s2", "magic_gru"]},
