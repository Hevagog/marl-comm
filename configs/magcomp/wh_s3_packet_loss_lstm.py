# fmt: off
"""S3 Packet Loss — MAGIC LSTM.

Textbook regime where recurrence > attention-alone (Foerster 2016 DIAL;
Sukhbaatar 2016 CommNet). LSTM cell smooths corrupted msg evidence in time;
GAT smooths in agent dim — orthogonal axes. Expected: clear lift over Dense.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s3_lstm", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s3", "magic_lstm"]},
