# fmt: off
"""CC Blind — MAGIC Persistent Hopfield (PH).

HopfieldStateCell: GRU-style carry (B, H=32) updated by Hopfield prototype-
attention over K=16 learned coordination attractors. Compared to EH (T=8
rolling buffer), HSC has 8× smaller carry and maintains a *persistent mode*
rather than a lookup table. Under the CC blind phase transition, the 16
prototypes act as discrete coordination-mode attractors — the gate decides
whether to snap to the nearest attractor or hold the current mode.

Literature: Ramsauer 2021 (§3.3 retrieval), Cho 2014 (GRU gate),
Goyal 2021 RIM (prototype competition).
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_cc_blind_ph", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "cc_blind", "magic_ph"]},
