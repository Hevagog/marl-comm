# fmt: off
"""S5 Scaled — MAGIC GRU (12 agents).

GRU at scale: lighter cell helps when 12-agent forward pass already
expensive. Same temporal-summarisation role as LSTM variant.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s5_gru_v3", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s5", "v3", "magic_gru"]},
