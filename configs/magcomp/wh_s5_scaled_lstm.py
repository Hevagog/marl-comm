# fmt: off
"""S5 Scaled — MAGIC LSTM (12 agents).

Recurrent encoder may help filter the 12-peer GAT noise floor — many of
each step's incoming messages are irrelevant; cell can summarise relevant
peer history into h_t before scheduler attends.
"""
