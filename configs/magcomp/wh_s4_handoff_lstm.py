# fmt: off
"""S4 Handoff — MAGIC LSTM.

Cell tracks "I just dropped at goal — fast peer should now pick up next item".
Implicit handoff timing without explicit comm phase channel.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s4_lstm", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s4", "magic_lstm"]},
