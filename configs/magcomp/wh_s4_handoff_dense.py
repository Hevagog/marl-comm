# fmt: off
"""S4 Handoff — MAGIC Dense.

Het-pair (slow-cap3 + fast-cap1) handoff chains via single goal cell. GAT
scheduler can route current carry/phase between fast/slow agents in O(1)
without a recurrent cell. Baseline isolating recurrent encoder lift.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s4_dense", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s4", "magic_dense"]},
