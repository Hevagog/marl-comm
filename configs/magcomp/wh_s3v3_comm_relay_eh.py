# fmt: off
"""S3-v3 Comm Relay — MAGIC Episodic Hopfield (EH).

no_comm=False: peer position/battery/carrying populated at comm_range=5.
MAGIC messages route peer vision patches. EH buffer of last T=16 obs_enc
vectors provides content-addressable retrieval: a frame where treatment was
in view can be recalled when a similar partial obs reappears (e.g., same
shelf context, different episode step).
...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s3v3_eh", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s3v3", "magic_eh", "comm_relay"]},
