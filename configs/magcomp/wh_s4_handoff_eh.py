# fmt: off
"""S4 Handoff — MAGIC Episodic Hopfield.

Buffer retrieves prior "I dropped at goal cell" obs_enc when the same context
recurs. Useful when handoff cycle period exceeds GRU/LSTM single-step memory
horizon — pattern completion gives sharper recall than running average.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s4_eh", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s4", "magic_eh"]},
