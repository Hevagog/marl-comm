# fmt: off
"""S2 Rendezvous — MAGIC LSTM (TBPTT(1)).

vision_range=1 means peers vanish from the patch repeatedly. LSTM hidden
state can hold last-known peer position across the steps it isn't visible,
giving the GAT scheduler stale-but-useful context to broadcast.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s2_lstm", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s2", "magic_lstm"]},
