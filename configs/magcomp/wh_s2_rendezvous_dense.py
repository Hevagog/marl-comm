# fmt: off
"""S2 Rendezvous — MAGIC Dense (FF encoder, no recurrent).

vision_range=1 hides peers; MAGIC's GAT scheduler routes "I'm at (x,y)" through
attention so dense encoder still suffices for spatial coordination. Baseline
for isolating recurrent encoder lift in a vision-bounded scenario.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s2_dense", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s2", "magic_dense"]},
