# fmt: off
"""CC Blind — MAGIC Episodic Hopfield (STRONGEST EH case).

target_vision_range=0.2 + vision_range=0.1 produce sparse, intermittent
sightings with zeroed slots otherwise. Pattern-completion buffer recalls
"saw target type-1 at p" obs_enc when slot recurs zeroed — sharper than
GRU's exponential decay. T=8, β=2.0 winner-take-most.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_cc_blind_eh", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "cc_blind", "magic_eh"]},
