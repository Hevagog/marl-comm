# fmt: off
"""CC Standard — MAPPO baseline.

4-agent k-of-n synchronized arrival on 2-3 targets within capture_radius.
vision_range=0.4. obs=30, state=28. MAPPO no comm — synchronisation luck.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_cc_std_mappo", "agent_type": "mappo",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "cc_std", "mappo"]},
