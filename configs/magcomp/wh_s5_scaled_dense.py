# fmt: off
"""S5 Scaled — MAGIC Dense (12 agents, 24×32).

Many-agent regime tests GAT scheduler scalability. msg_dim=96, rounds=3,
heads=4 sized for 12-agent attention. Lower entropy floor (CommFormer-like)
— 12-agent action space inflates entropy term magnitude.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s5_dense_v2", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s5", "v2", "magic_dense"]},
