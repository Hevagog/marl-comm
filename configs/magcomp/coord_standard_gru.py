# fmt: off
"""CC Standard — MAGIC GRU.

Lighter recurrent cell tracking last-seen peer trajectory across vision drop.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_cc_std_gru", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "cc_std", "magic_gru"]},
