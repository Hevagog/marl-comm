# fmt: off
"""S4 Handoff — MAGIC GRU.

GRU-equivalent of LSTM variant: tracks last-handoff-event in h_t to time
fast↔slow chaining. Lighter cell, often matches LSTM under TBPTT(1).
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s4_gru", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s4", "magic_gru"]},
