# fmt: off
"""CC Standard — MAGIC Dense.

GAT scheduler routes "I'm headed to target k" — enables k-of-n synchronisation
...
CONFIG = {
    "experiment": {
        "name": "magcomp_cc_std_dense", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "cc_std", "magic_dense"]},
