# fmt: off
"""S5 Scaled — MAPPO baseline (12 agents, 24×32).

Many-agent dense regime; tests whether MAPPO scales without comm. Expected:
saturates well below MAGIC variants since 12 peers = O(N²) coord problem.
"""
...
CONFIG = {
    ...
    "mappo": {
        "rollouts": 512, "learning_epochs": 8, "mini_batches": 4,
