# fmt: off
"""Coin Game — MAGIC LSTM.

Cell can track recent steal events and modulate retaliation timing — useful
for tit-for-tat-style equilibria. Recurrent_hidden_size=32 (matches msg_dim).
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_coingame_lstm", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "coingame", "magic_lstm"]},
