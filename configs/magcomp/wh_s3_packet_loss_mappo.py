# fmt: off
"""S3 Packet Loss — MAPPO dense baseline.

Noisy comm channel (5% base + 40% interference boost near treatment + 10%
load-dependent congestion). MAPPO has no comm channel so packet loss is
moot for it; serves as no-comm floor.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s3_mappo", "agent_type": "mappo",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s3", "mappo"]},
