# fmt: off
"""Coin Game — MAGIC Dense.

GAT comm enables intent-signalling ("I'm going for blue") which can stabilise
non-aggression equilibria absent in MAPPO. Tiny env, small arch.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_coingame_dense", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "coingame", "magic_dense"]},
