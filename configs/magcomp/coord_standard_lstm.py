# fmt: off
"""CC Standard — MAGIC LSTM.

Cell holds last-known peer trajectory across vision dropouts (vision_range=0.4
means peers fade in/out frequently in 4-agent setting).
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_cc_std_lstm", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "cc_std", "magic_lstm"]},
