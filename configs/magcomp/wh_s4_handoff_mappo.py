# fmt: off
"""S4 Handoff — MAPPO baseline.

Alternating speed (1,3,1,3) + capacity (3,1,3,1) → fast-low-cap and slow-high-
cap pairs. Single goal location queues handoffs. MAPPO has no peer phase
signal; cannot route fast↔slow handoff chains.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s4_mappo", "agent_type": "mappo",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s4", "mappo"]},
