...
GRU variant: same retaliation-tracking role as LSTM with smaller cell.
"""
...
CONFIG = {
    "experiment": {
        "name": "magcomp_coingame_gru", "agent_type": "magic",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "coingame", "magic_gru"]},
