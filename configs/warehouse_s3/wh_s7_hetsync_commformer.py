...
CONFIG = {
    "experiment": {
        "name": "magcomp_wh_s7_commformer", "agent_type": "commformer",
        "directory": "runs", "wandb": True,
        "wandb_kwargs": {"project": "marl-comm", "tags": ["magcomp", "wh_s7", "commformer"]},
    ...
    "commformer": {
        ...
        "kl_threshold": 0.05, "kl_warmup_fraction": 0.3,
        ...
        "hidden_dim": 128, "num_blocks": 2, "num_heads": 2,
