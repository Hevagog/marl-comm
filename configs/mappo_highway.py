...
CONFIG = {
    "experiment": {
        "name":             "mappo_highway_v0",
        "agent_type":       "mappo",
        "directory":        "runs",
        "wandb":            True,
        "wandb_kwargs": {
            "project": "marl-comm",
            "tags":    ["mappo", "highway", "intersection"],
        },
        "write_interval":      "auto",
    ...
    "mappo": {
        ...
        "value_loss_scale":         1.0,    # 1.0 is correct for separate policy/value optimizers
        ...
        "lr_decay_start_fraction": 0.3,     # Hold full LR for first 30% of training
        "min_lr_fraction":         0.1,
    },
