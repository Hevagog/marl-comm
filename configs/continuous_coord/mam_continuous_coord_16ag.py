# fmt: off
# MAM encoder-only (BiMamba encoder + per-agent MLP head) on continuous_coord, 16 agents.
# WARNING: BiMamba positional bias scales with n; agent-0 gradient ~15× more influential
# than agent-15 at n=16. Expected high clip rates or learning failure (see §11.5 / §7.3
# in Hopfield_Energy_Transformer_for_MAMEncoderOnly.md).
...
CONFIG = {
    "experiment": {
        "name":             "mam_enc_only_continuous_coord_16ag_v1",
