...
from agents.magic_hopfield.magic_hopfield_mappo import MAGICHopfieldMAPPO
from agents.magic_hopfield.models.generators import create_magic_hopfield_models
from agents.runner import BaseRunner


class MAGICHopfieldRunner(BaseRunner):
    def _build_agent(self) -> MAGICHopfieldMAPPO:
        env = self._env
        cfg = self._cfg
        ...
        models = create_magic_hopfield_models(
        ...
        project_cfg = cfg.get("magic_hopfield", {})
