...
from agents.mat.mat_mappo import MATAgent
from agents.mat.models.generators import create_mat_models
from agents.runner import BaseRunner


class MATRunner(BaseRunner):
    def _build_agent(self) -> MATAgent:
        env = self._env
        cfg = self._cfg
