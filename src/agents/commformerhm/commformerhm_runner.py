...
from agents.commformerhm.commformerhm_mappo import CommFormerHMMAPPO
from agents.commformerhm.models.generators import create_commformerhm_models
from agents.runner import BaseRunner


class CommFormerHMRunner(BaseRunner):
    def _build_agent(self) -> CommFormerHMMAPPO:
        env = self._env
        cfg = self._cfg
        ...
        models = create_commformerhm_models(
        ...
        project_cfg = cfg.get("commformerhm", {})
