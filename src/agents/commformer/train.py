...
class CommFormerRunner(BaseRunner):
    def _build_agent(self) -> CommFormerMAPPO:
        env = self._env
        cfg = self._cfg
        ...
        models = create_commformer_models(
        ...
        project_cfg = cfg.get("commformer", {})
