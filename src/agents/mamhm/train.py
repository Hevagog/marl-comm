...
from agents.mamhm.mamhm_mappo import MAMHMMAPPO
from agents.mamhm.models.generators import create_mamhm_models
from agents.runner import BaseRunner


class MAMHMRunner(BaseRunner):
    def _build_agent(self) -> MAMHMMAPPO:
        env = self._env
        cfg = self._cfg
