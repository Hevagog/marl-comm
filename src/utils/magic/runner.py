...
Add the following method to your MagicRunner class:
    ...
    def analyze_magic(
        ...
        from utils.magic.runner import run_magic_analysis
...
def run_magic_analysis(
    ...
    """
    from utils.magic.coingame_analysis import MAGICCommCollector
    from utils.magic.coingame_visualizer import (
        save_all_magic_figures_extended as save_all_magic_figures,
    )
