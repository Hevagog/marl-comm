...
def _parse_obs(
    ...
    tuple[int, int] | None,  # red coin pos (None = absent)
    tuple[int, int] | None,  # blue coin pos
]:
    ...
    # Red coin
    red_coin: tuple[int, int] | None = None
    ...
    # Blue coin
    blue_coin: tuple[int, int] | None = None
...
def _detect_coin_events(
    step: int,
    prev_red_coin: tuple[int, int] | None,
    prev_blue_coin: tuple[int, int] | None,
    curr_red_coin: tuple[int, int] | None,
    curr_blue_coin: tuple[int, int] | None,
